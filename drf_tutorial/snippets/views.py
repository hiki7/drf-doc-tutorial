...
#     queryset = Snippet.objects.all()
#     serializer_class = SnippetSerializer
#     #IsAuthenticatedOrReadOnly will make sure that authenticated requests get read-write access and
...
class SnippetViewSet(viewsets.ModelViewSet): #ModelViewSet provides full set of actions
    ...
    #action decorator is used for creating custom endpoints that don't fit standard create/update/delete style
